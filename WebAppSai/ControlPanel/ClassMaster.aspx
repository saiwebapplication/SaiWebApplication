                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group has-error">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="txtClassName" runat="server" ErrorMessage="Please enter class name" ForeColor="Red"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                            ...
                            <div class="table-responsive">
                                <center>
                                    <asp:GridView ID="dgvClass" runat="server" Width="100%" AutoGenerateColumns="false" class="table table-striped"
                                        GridLines="None" AllowPaging="false" CellPadding="0" CellSpacing="0" DataKeyNames="ClassId" ForeColor="#333333" OnRowCommand="dgvClassMaster_RowCommand">
                                        <Columns>
